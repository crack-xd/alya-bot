module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['6281350323701', '6281350323701']
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/KgBwia320AJ68u5g9E3I2h'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         chatbot: false,
         onlyprefix: '+',
         owners: ['6289530656600', '6289530656600'],
